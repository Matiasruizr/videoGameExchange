...
class PublicacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publicacion" do
    assert_difference('Publicacion.count') do
      post publicacions_url, params: { publicacion: { comentarios: @publicacion.comentarios, nombreJuegoOfrece: @publicacion.nombreJuegoOfrece, nombreJuegobusca: @publicacion.nombreJuegobusca, usuario: @publicacion.usuario } }
    end
  ...
  test "should update publicacion" do
    patch publicacion_url(@publicacion), params: { publicacion: { comentarios: @publicacion.comentarios, nombreJuegoOfrece: @publicacion.nombreJuegoOfrece, nombreJuegobusca: @publicacion.nombreJuegobusca, usuario: @publicacion.usuario } }
