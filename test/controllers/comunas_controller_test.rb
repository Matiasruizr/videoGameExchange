...
class ComunasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comuna" do
    assert_difference('Comuna.count') do
      post comunas_url, params: { comuna: { id_provincia: @comuna.id_provincia, nombre: @comuna.nombre } }
    end
  ...
  test "should update comuna" do
    patch comuna_url(@comuna), params: { comuna: { id_provincia: @comuna.id_provincia, nombre: @comuna.nombre } }
