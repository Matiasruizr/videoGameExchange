...
class RegionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create region" do
    assert_difference('Region.count') do
      post regions_url, params: { region: { id_pais: @region.id_pais, nombre: @region.nombre } }
    end
  ...
  test "should update region" do
    patch region_url(@region), params: { region: { id_pais: @region.id_pais, nombre: @region.nombre } }
